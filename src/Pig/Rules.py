class Rules:
    ...
    def showRules(self):
        ...
        print("4. Each number they roll, except for a 1, is added to their score this turn; but if they roll a 1, their score for this turn is zero, and their turn ends.")
